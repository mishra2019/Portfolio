...
function RotatingRole({ roles }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-8 min-[400px]:h-9 sm:h-10 flex items-center justify-center overflow-hidden w-full max-w-[min(100%,22rem)] min-[400px]:max-w-none px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.p,
    {
      initial: { opacity: 0, y: 20 },
...
function ContactBarRow({ item }) {
  const Icon2 = item.icon;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "contact-bar-item min-w-0 max-w-[min(100%,20rem)] sm:max-w-none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "contact-bar-icon-wrap shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-3 h-3" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "min-w-0 break-words text-left sm:text-center", children: item.text })
  ] });
}
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-4 h-4 shrink-0" }),
                        "Let's Connect"
                      ]
                    }
                  )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl w-full mx-auto flex flex-wrap items-center justify-center gap-x-2 gap-y-2.5 px-3 sm:px-4 md:px-6 lg:px-10", children: contactItems.map(
          (item) => item.href ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: item.href,
              target: item.external ? "_blank" : void 0,
              rel: "noreferrer",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactBarRow, { item })
            },
            item.text
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactBarRow, { item }) }, item.text)
        ) })
      }
    )
  ] });
