    ...
    <Section id="experience" className="section-alt">
      ...
      <div className="relative">
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, oklch(0.42 0.03 252) 0%, oklch(0.32 0.014 85) 100%)",
          }}
        />
        ...
        <div className="flex flex-col gap-8">
          {experiences.map((exp, i) => (
            ...
            >
              <div className="absolute -left-3 top-7 w-3.5 h-3.5 rounded-full timeline-dot hidden sm:block ring-4 ring-[oklch(0.14_0.008_85)]" />

              <div className="p-6 pb-4 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 border-b border-[oklch(0.34_0.014_85/0.45)]">
