import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, m as motion, u as usePortfolioData, A as AnimatePresence } from "./index-BFYYVlAX.js";
/**
...
function Card({ className, delay = 0, slideFrom = "up", children, ...props }) {
...
function Section({ id, children, className = "", alt = false }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id, className: `py-16 px-4 sm:px-6 lg:px-10 ${alt ? "section-alt" : ""} ${className}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children }) });
}
